...
const changePassword = async (req, res) => {
  try {
    const userId = req.user.id; // ມາຈາກ JWT middleware
    ...
    // ກວດສອບວ່າ password ໃໝ່ກັບຢືນຢັນກົງກັນບໍ່
    ...
    // ກວດສອບວ່າ password ໃໝ່ບໍ່ຄືກັບເກົ່າ
    ...
    db.get(
      ...
      async (err, user) => {
        ...
        if (!isPasswordValid) {
          // ບັນທຶກ audit log ສຳລັບການພະຍາຍາມປ່ຽນ password ທີ່ລົ້ມເຫຼວ
          logAuditAction(
            userId,
            user.username,
